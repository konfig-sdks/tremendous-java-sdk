...
public class FundingSourcesGetByIdResponseFundingSourceMeta {
 ...
 public enum NetworkEnum {
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta() {
  }

  public FundingSourcesGetByIdResponseFundingSourceMeta availableCents(Integer availableCents) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta pendingCents(Integer pendingCents) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta accountholderName(String accountholderName) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta accountType(AccountTypeEnum accountType) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta bankName(String bankName) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta accountNumberMask(String accountNumberMask) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta accountRoutingMask(String accountRoutingMask) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta refundable(Boolean refundable) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta network(NetworkEnum network) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta last4(String last4) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta expired(Boolean expired) {
  ...
  **/
  ...
  public FundingSourcesGetByIdResponseFundingSourceMeta lastPaymentFailedAt(OffsetDateTime lastPaymentFailedAt) {
  ...
  **/
   ...
   * @return the FundingSourcesGetByIdResponseFundingSourceMeta instance itself
   */
  public FundingSourcesGetByIdResponseFundingSourceMeta putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FundingSourcesGetByIdResponseFundingSourceMeta fundingSourcesGetByIdResponseFundingSourceMeta = (FundingSourcesGetByIdResponseFundingSourceMeta) o;
    return Objects.equals(this.availableCents, fundingSourcesGetByIdResponseFundingSourceMeta.availableCents) &&
        Objects.equals(this.pendingCents, fundingSourcesGetByIdResponseFundingSourceMeta.pendingCents) &&
        Objects.equals(this.accountholderName, fundingSourcesGetByIdResponseFundingSourceMeta.accountholderName) &&
        Objects.equals(this.accountType, fundingSourcesGetByIdResponseFundingSourceMeta.accountType) &&
        Objects.equals(this.bankName, fundingSourcesGetByIdResponseFundingSourceMeta.bankName) &&
        Objects.equals(this.accountNumberMask, fundingSourcesGetByIdResponseFundingSourceMeta.accountNumberMask) &&
        Objects.equals(this.accountRoutingMask, fundingSourcesGetByIdResponseFundingSourceMeta.accountRoutingMask) &&
        Objects.equals(this.refundable, fundingSourcesGetByIdResponseFundingSourceMeta.refundable) &&
        Objects.equals(this.network, fundingSourcesGetByIdResponseFundingSourceMeta.network) &&
        Objects.equals(this.last4, fundingSourcesGetByIdResponseFundingSourceMeta.last4) &&
        Objects.equals(this.expired, fundingSourcesGetByIdResponseFundingSourceMeta.expired) &&
        Objects.equals(this.lastPaymentFailedAt, fundingSourcesGetByIdResponseFundingSourceMeta.lastPaymentFailedAt)&&
        Objects.equals(this.additionalProperties, fundingSourcesGetByIdResponseFundingSourceMeta.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FundingSourcesGetByIdResponseFundingSourceMeta {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FundingSourcesGetByIdResponseFundingSourceMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FundingSourcesGetByIdResponseFundingSourceMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FundingSourcesGetByIdResponseFundingSourceMeta is not found in the empty JSON string", FundingSourcesGetByIdResponseFundingSourceMeta.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FundingSourcesGetByIdResponseFundingSourceMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FundingSourcesGetByIdResponseFundingSourceMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FundingSourcesGetByIdResponseFundingSourceMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FundingSourcesGetByIdResponseFundingSourceMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<FundingSourcesGetByIdResponseFundingSourceMeta>() {
           @Override
           public void write(JsonWriter out, FundingSourcesGetByIdResponseFundingSourceMeta value) throws IOException {
           ...
           @Override
           public FundingSourcesGetByIdResponseFundingSourceMeta read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FundingSourcesGetByIdResponseFundingSourceMeta instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FundingSourcesGetByIdResponseFundingSourceMeta given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FundingSourcesGetByIdResponseFundingSourceMeta
  * @throws IOException if the JSON string is invalid with respect to FundingSourcesGetByIdResponseFundingSourceMeta
  */
  public static FundingSourcesGetByIdResponseFundingSourceMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FundingSourcesGetByIdResponseFundingSourceMeta.class);
  }

 /**
  * Convert an instance of FundingSourcesGetByIdResponseFundingSourceMeta to an JSON string
  *
  * @return JSON string
  */
