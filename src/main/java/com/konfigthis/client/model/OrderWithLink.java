...
import com.konfigthis.client.model.OrderWithLinkPayment;
import com.konfigthis.client.model.OrderWithLinkRewardsInner;
...
public class OrderWithLink {
 ...
 public enum StatusEnum {
  ...
  private OrderWithLinkPayment payment;
  ...
  private List<OrderWithLinkRewardsInner> rewards = null;

  public OrderWithLink() {
  }
  ...
  **/
  ...
  public OrderWithLink externalId(String externalId) {
  ...
  **/
  ...
  public OrderWithLink payment(OrderWithLinkPayment payment) {
  ...
  **/
  ...
  public OrderWithLinkPayment getPayment() {
    return payment;
  }


  public void setPayment(OrderWithLinkPayment payment) {
  ...
  **/
  ...
  public OrderWithLink rewards(List<OrderWithLinkRewardsInner> rewards) {
  ...
  public OrderWithLink addRewardsItem(OrderWithLinkRewardsInner rewardsItem) {
  ...
  **/
  ...
  public List<OrderWithLinkRewardsInner> getRewards() {
    return rewards;
  }


  public void setRewards(List<OrderWithLinkRewardsInner> rewards) {
   ...
   * @return the OrderWithLink instance itself
   */
  public OrderWithLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderWithLink orderWithLink = (OrderWithLink) o;
    return Objects.equals(this.id, orderWithLink.id) &&
        Objects.equals(this.externalId, orderWithLink.externalId) &&
        Objects.equals(this.campaignId, orderWithLink.campaignId) &&
        Objects.equals(this.createdAt, orderWithLink.createdAt) &&
        Objects.equals(this.status, orderWithLink.status) &&
        Objects.equals(this.payment, orderWithLink.payment) &&
        Objects.equals(this.invoiceId, orderWithLink.invoiceId) &&
        Objects.equals(this.rewards, orderWithLink.rewards)&&
        Objects.equals(this.additionalProperties, orderWithLink.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderWithLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderWithLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderWithLink is not found in the empty JSON string", OrderWithLink.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderWithLink.openapiRequiredFields) {
      ...
      if (jsonObj.get("payment") != null && !jsonObj.get("payment").isJsonNull()) {
        OrderWithLinkPayment.validateJsonObject(jsonObj.getAsJsonObject("payment"));
      }
      ...
      if (jsonObj.get("rewards") != null && !jsonObj.get("rewards").isJsonNull()) {
        ...
        if (jsonArrayrewards != null) {
          ...
          for (int i = 0; i < jsonArrayrewards.size(); i++) {
            OrderWithLinkRewardsInner.validateJsonObject(jsonArrayrewards.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderWithLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderWithLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderWithLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderWithLink.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderWithLink>() {
           @Override
           public void write(JsonWriter out, OrderWithLink value) throws IOException {
           ...
           @Override
           public OrderWithLink read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderWithLink instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderWithLink given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderWithLink
  * @throws IOException if the JSON string is invalid with respect to OrderWithLink
  */
  public static OrderWithLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderWithLink.class);
  }

 /**
  * Convert an instance of OrderWithLink to an JSON string
  *
  * @return JSON string
  */
