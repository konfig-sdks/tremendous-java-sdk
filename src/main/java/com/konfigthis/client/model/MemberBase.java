...
public class MemberBase {
  ...
  **/
  ...
  public MemberBase email(String email) {
  ...
  **/
  ...
  public MemberBase role(RoleEnum role) {
  ...
  **/
   ...
   * @return the MemberBase instance itself
   */
  public MemberBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, memberBase.id) &&
        Objects.equals(this.email, memberBase.email) &&
        Objects.equals(this.name, memberBase.name) &&
        Objects.equals(this.role, memberBase.role) &&
        Objects.equals(this.status, memberBase.status)&&
        Objects.equals(this.additionalProperties, memberBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, email, name, role, status, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MemberBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MemberBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemberBase is not found in the empty JSON string", MemberBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MemberBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberBase.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberBase>() {
           @Override
           public void write(JsonWriter out, MemberBase value) throws IOException {
           ...
           @Override
           public MemberBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MemberBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MemberBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberBase
  * @throws IOException if the JSON string is invalid with respect to MemberBase
  */
  public static MemberBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberBase.class);
  }

 /**
  * Convert an instance of MemberBase to an JSON string
  *
  * @return JSON string
  */
