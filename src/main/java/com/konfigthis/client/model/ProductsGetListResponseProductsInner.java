...
import com.konfigthis.client.model.ProductsGetListResponseProductsInnerCountriesInner;
import com.konfigthis.client.model.ProductsGetListResponseProductsInnerSkusInner;
...
public class ProductsGetListResponseProductsInner {
 ...
 public enum CategoryEnum {
  ...
  private List<ProductsGetListResponseProductsInnerSkusInner> skus = null;
 ...
 public enum CurrencyCodesEnum {
  ...
  private List<ProductsGetListResponseProductsInnerCountriesInner> countries = new ArrayList<>();

  public static final String SERIALIZED_NAME_IMAGES = "images";
  @SerializedName(SERIALIZED_NAME_IMAGES)
  private List<ProductImagesInner> images = new ArrayList<>();

  public ProductsGetListResponseProductsInner() {
  }

  public ProductsGetListResponseProductsInner description(String description) {
  ...
  **/
  ...
  public ProductsGetListResponseProductsInner id(String id) {
  ...
  **/
  ...
  public ProductsGetListResponseProductsInner name(String name) {
  ...
  **/
  ...
  public ProductsGetListResponseProductsInner category(CategoryEnum category) {
  ...
  **/
  ...
  public ProductsGetListResponseProductsInner disclosure(String disclosure) {
  ...
  **/
  ...
  public ProductsGetListResponseProductsInner skus(List<ProductsGetListResponseProductsInnerSkusInner> skus) {
  ...
  public ProductsGetListResponseProductsInner addSkusItem(ProductsGetListResponseProductsInnerSkusInner skusItem) {
    if (this.skus == null) {
  ...
  **/
  ...
  public List<ProductsGetListResponseProductsInnerSkusInner> getSkus() {
    return skus;
  }


  public void setSkus(List<ProductsGetListResponseProductsInnerSkusInner> skus) {
  ...
  public ProductsGetListResponseProductsInner currencyCodes(List<CurrencyCodesEnum> currencyCodes) {
  ...
  public ProductsGetListResponseProductsInner addCurrencyCodesItem(CurrencyCodesEnum currencyCodesItem) {
  ...
  **/
  ...
  public ProductsGetListResponseProductsInner countries(List<ProductsGetListResponseProductsInnerCountriesInner> countries) {
  ...
  public ProductsGetListResponseProductsInner addCountriesItem(ProductsGetListResponseProductsInnerCountriesInner countriesItem) {
  ...
  **/
  ...
  public List<ProductsGetListResponseProductsInnerCountriesInner> getCountries() {
    return countries;
  }


  public void setCountries(List<ProductsGetListResponseProductsInnerCountriesInner> countries) {
  ...
  public ProductsGetListResponseProductsInner images(List<ProductImagesInner> images) {
  ...
  public ProductsGetListResponseProductsInner addImagesItem(ProductImagesInner imagesItem) {
  ...
  **/
   ...
   * @return the ProductsGetListResponseProductsInner instance itself
   */
  public ProductsGetListResponseProductsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsGetListResponseProductsInner productsGetListResponseProductsInner = (ProductsGetListResponseProductsInner) o;
    return Objects.equals(this.description, productsGetListResponseProductsInner.description) &&
        Objects.equals(this.id, productsGetListResponseProductsInner.id) &&
        Objects.equals(this.name, productsGetListResponseProductsInner.name) &&
        Objects.equals(this.category, productsGetListResponseProductsInner.category) &&
        Objects.equals(this.disclosure, productsGetListResponseProductsInner.disclosure) &&
        Objects.equals(this.skus, productsGetListResponseProductsInner.skus) &&
        Objects.equals(this.currencyCodes, productsGetListResponseProductsInner.currencyCodes) &&
        Objects.equals(this.countries, productsGetListResponseProductsInner.countries) &&
        Objects.equals(this.images, productsGetListResponseProductsInner.images)&&
        Objects.equals(this.additionalProperties, productsGetListResponseProductsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsGetListResponseProductsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsGetListResponseProductsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsGetListResponseProductsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsGetListResponseProductsInner is not found in the empty JSON string", ProductsGetListResponseProductsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductsGetListResponseProductsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("skus") != null && !jsonObj.get("skus").isJsonNull()) {
        ...
        if (jsonArrayskus != null) {
          ...
          for (int i = 0; i < jsonArrayskus.size(); i++) {
            ProductsGetListResponseProductsInnerSkusInner.validateJsonObject(jsonArrayskus.get(i).getAsJsonObject());
          };
        }
      }
      ...
      for (int i = 0; i < jsonArraycountries.size(); i++) {
        ProductsGetListResponseProductsInnerCountriesInner.validateJsonObject(jsonArraycountries.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsGetListResponseProductsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsGetListResponseProductsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsGetListResponseProductsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsGetListResponseProductsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsGetListResponseProductsInner>() {
           @Override
           public void write(JsonWriter out, ProductsGetListResponseProductsInner value) throws IOException {
           ...
           @Override
           public ProductsGetListResponseProductsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsGetListResponseProductsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsGetListResponseProductsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsGetListResponseProductsInner
  * @throws IOException if the JSON string is invalid with respect to ProductsGetListResponseProductsInner
  */
  public static ProductsGetListResponseProductsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsGetListResponseProductsInner.class);
  }

 /**
  * Convert an instance of ProductsGetListResponseProductsInner to an JSON string
  *
  * @return JSON string
  */
