...
import com.konfigthis.client.model.OrderWithoutLinkPayment;
import com.konfigthis.client.model.OrderWithoutLinkReward;
...
public class OrderWithoutLink {
 ...
 public enum StatusEnum {
  ...
  private OrderWithoutLinkPayment payment;
  ...
  private OrderWithoutLinkReward reward;

  public OrderWithoutLink() {
  }
  ...
  **/
  ...
  public OrderWithoutLink externalId(String externalId) {
  ...
  **/
  ...
  public OrderWithoutLink payment(OrderWithoutLinkPayment payment) {
  ...
  **/
  ...
  public OrderWithoutLinkPayment getPayment() {
    return payment;
  }


  public void setPayment(OrderWithoutLinkPayment payment) {
  ...
  **/
  ...
  public OrderWithoutLink reward(OrderWithoutLinkReward reward) {
  ...
  **/
  ...
  public OrderWithoutLinkReward getReward() {
    return reward;
  }


  public void setReward(OrderWithoutLinkReward reward) {
   ...
   * @return the OrderWithoutLink instance itself
   */
  public OrderWithoutLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderWithoutLink orderWithoutLink = (OrderWithoutLink) o;
    return Objects.equals(this.id, orderWithoutLink.id) &&
        Objects.equals(this.externalId, orderWithoutLink.externalId) &&
        Objects.equals(this.campaignId, orderWithoutLink.campaignId) &&
        Objects.equals(this.createdAt, orderWithoutLink.createdAt) &&
        Objects.equals(this.status, orderWithoutLink.status) &&
        Objects.equals(this.payment, orderWithoutLink.payment) &&
        Objects.equals(this.invoiceId, orderWithoutLink.invoiceId) &&
        Objects.equals(this.reward, orderWithoutLink.reward)&&
        Objects.equals(this.additionalProperties, orderWithoutLink.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderWithoutLink {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderWithoutLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderWithoutLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderWithoutLink is not found in the empty JSON string", OrderWithoutLink.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderWithoutLink.openapiRequiredFields) {
      ...
      if (jsonObj.get("payment") != null && !jsonObj.get("payment").isJsonNull()) {
        OrderWithoutLinkPayment.validateJsonObject(jsonObj.getAsJsonObject("payment"));
      }
      ...
      if (jsonObj.get("reward") != null && !jsonObj.get("reward").isJsonNull()) {
        OrderWithoutLinkReward.validateJsonObject(jsonObj.getAsJsonObject("reward"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderWithoutLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderWithoutLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderWithoutLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderWithoutLink.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderWithoutLink>() {
           @Override
           public void write(JsonWriter out, OrderWithoutLink value) throws IOException {
           ...
           @Override
           public OrderWithoutLink read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderWithoutLink instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderWithoutLink given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderWithoutLink
  * @throws IOException if the JSON string is invalid with respect to OrderWithoutLink
  */
  public static OrderWithoutLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderWithoutLink.class);
  }

 /**
  * Convert an instance of OrderWithoutLink to an JSON string
  *
  * @return JSON string
  */
