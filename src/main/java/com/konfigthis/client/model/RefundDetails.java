...
public class RefundDetails {
  ...
  **/
   ...
   * @return the RefundDetails instance itself
   */
  public RefundDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, refundDetails.total)&&
        Objects.equals(this.additionalProperties, refundDetails.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RefundDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RefundDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RefundDetails>() {
           ...
           public RefundDetails read(JsonReader in) throws IOException {
             ...
             RefundDetails instance = thisAdapter.fromJsonTree(jsonObj);
