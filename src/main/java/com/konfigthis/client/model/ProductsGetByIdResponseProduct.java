...
public class ProductsGetByIdResponseProduct {
 ...
 public enum CategoryEnum {
  ...
  private List<ProductsGetByIdResponseProductSkusInner> skus = null;
 ...
 public enum CurrencyCodesEnum {
  ...
  private List<ProductsGetByIdResponseProductCountriesInner> countries = new ArrayList<>();

  public static final String SERIALIZED_NAME_IMAGES = "images";
  @SerializedName(SERIALIZED_NAME_IMAGES)
  private List<ProductImagesInner> images = new ArrayList<>();

  public ProductsGetByIdResponseProduct() {
  }

  public ProductsGetByIdResponseProduct description(String description) {
  ...
  **/
  ...
  public ProductsGetByIdResponseProduct id(String id) {
  ...
  **/
  ...
  public ProductsGetByIdResponseProduct name(String name) {
  ...
  **/
  ...
  public ProductsGetByIdResponseProduct category(CategoryEnum category) {
  ...
  **/
  ...
  public ProductsGetByIdResponseProduct disclosure(String disclosure) {
  ...
  **/
  ...
  public ProductsGetByIdResponseProduct skus(List<ProductsGetByIdResponseProductSkusInner> skus) {
  ...
  public ProductsGetByIdResponseProduct addSkusItem(ProductsGetByIdResponseProductSkusInner skusItem) {
    if (this.skus == null) {
  ...
  **/
  ...
  public List<ProductsGetByIdResponseProductSkusInner> getSkus() {
    return skus;
  }


  public void setSkus(List<ProductsGetByIdResponseProductSkusInner> skus) {
  ...
  public ProductsGetByIdResponseProduct currencyCodes(List<CurrencyCodesEnum> currencyCodes) {
  ...
  public ProductsGetByIdResponseProduct addCurrencyCodesItem(CurrencyCodesEnum currencyCodesItem) {
  ...
  **/
  ...
  public ProductsGetByIdResponseProduct countries(List<ProductsGetByIdResponseProductCountriesInner> countries) {
  ...
  public ProductsGetByIdResponseProduct addCountriesItem(ProductsGetByIdResponseProductCountriesInner countriesItem) {
  ...
  **/
  ...
  public List<ProductsGetByIdResponseProductCountriesInner> getCountries() {
    return countries;
  }


  public void setCountries(List<ProductsGetByIdResponseProductCountriesInner> countries) {
  ...
  public ProductsGetByIdResponseProduct images(List<ProductImagesInner> images) {
  ...
  public ProductsGetByIdResponseProduct addImagesItem(ProductImagesInner imagesItem) {
  ...
  **/
   ...
   * @return the ProductsGetByIdResponseProduct instance itself
   */
  public ProductsGetByIdResponseProduct putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsGetByIdResponseProduct productsGetByIdResponseProduct = (ProductsGetByIdResponseProduct) o;
    return Objects.equals(this.description, productsGetByIdResponseProduct.description) &&
        Objects.equals(this.id, productsGetByIdResponseProduct.id) &&
        Objects.equals(this.name, productsGetByIdResponseProduct.name) &&
        Objects.equals(this.category, productsGetByIdResponseProduct.category) &&
        Objects.equals(this.disclosure, productsGetByIdResponseProduct.disclosure) &&
        Objects.equals(this.skus, productsGetByIdResponseProduct.skus) &&
        Objects.equals(this.currencyCodes, productsGetByIdResponseProduct.currencyCodes) &&
        Objects.equals(this.countries, productsGetByIdResponseProduct.countries) &&
        Objects.equals(this.images, productsGetByIdResponseProduct.images)&&
        Objects.equals(this.additionalProperties, productsGetByIdResponseProduct.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsGetByIdResponseProduct {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductsGetByIdResponseProduct
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductsGetByIdResponseProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductsGetByIdResponseProduct is not found in the empty JSON string", ProductsGetByIdResponseProduct.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductsGetByIdResponseProduct.openapiRequiredFields) {
      ...
      if (jsonObj.get("skus") != null && !jsonObj.get("skus").isJsonNull()) {
        ...
        if (jsonArrayskus != null) {
          ...
          for (int i = 0; i < jsonArrayskus.size(); i++) {
            ProductsGetByIdResponseProductSkusInner.validateJsonObject(jsonArrayskus.get(i).getAsJsonObject());
          };
        }
      }
      ...
      for (int i = 0; i < jsonArraycountries.size(); i++) {
        ProductsGetByIdResponseProductCountriesInner.validateJsonObject(jsonArraycountries.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsGetByIdResponseProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsGetByIdResponseProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsGetByIdResponseProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsGetByIdResponseProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsGetByIdResponseProduct>() {
           @Override
           public void write(JsonWriter out, ProductsGetByIdResponseProduct value) throws IOException {
           ...
           @Override
           public ProductsGetByIdResponseProduct read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductsGetByIdResponseProduct instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductsGetByIdResponseProduct given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductsGetByIdResponseProduct
  * @throws IOException if the JSON string is invalid with respect to ProductsGetByIdResponseProduct
  */
  public static ProductsGetByIdResponseProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsGetByIdResponseProduct.class);
  }

 /**
  * Convert an instance of ProductsGetByIdResponseProduct to an JSON string
  *
  * @return JSON string
  */
