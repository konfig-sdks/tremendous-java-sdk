...
# OrderWithLinkRewardsInnerDelivery
...
|**link** | **String** | Link to redeem the reward at. You need to deliver this link to the recipient.  Only available for rewards for which the &#x60;method&#x60; for delivery is set to &#x60;LINK&#x60;.  |  [optional] [readonly] |
